...
const Check = () => {
  ...
  const [select, setSelect] = useState("mobile")
  ...
  const agreeTableDoc = () => {
    ...
    return(
          <Table  >
            ...
            <tr>
              <td>서비스 제공</td>
              <td><div className="div_table">환자의 의료진 예약 일정</div></td>
  ...
  ?
    ...
    :
    content = `엠닥홈케어 의료진회원 이용약관
    시행일자 : 2022년 1월 24일
    공고일자 : 2022년 1월 24일
    
    제 1 조 (목적)
    이 약관은 주식회사 엠닥(이하 “회사”라 합니다)이 제공하는 엠닥홈케어 서비스(이하 “서비스”라 합니다)의 이용과 관련하여 의료진회원(이하 “회원”이라고만 합니다)과 회사의 관계와 권리의무 등을 규정함을 목적으로 합니다.
    
    제 2 조 (정의)
    ①	본 약관에서 사용하는 정의는 다음과 같습니다.
    1.	“웹”이라 함은 회사가 의료진에게 서비스를 제공하기 위하여 사용하는 웹 페이지를 의미합니다.
    2.	“회원”이라 함은 회사와 계약을 체결한 의료기관 등에 소속된 의사 등으로서 회사의 서비스에 가입한 의료진회원을 의미합니다.
    3.	“환자”라 함은 회원이 소속된 의료기관 등의 환자로서 의료진회원이 환자번호를 등록하고 관리하는 자를 의미합니다.
    4.	“mDocHomecare 챗봇”이라 함은 회원의 사전문진에 필요한 점검항목을 자동화한 알고리즘을 의미합니다. 
    5.	“mDocHomecare 메신저”라 함은 회원이 담당 의료진과 직접 소통할 수 있는 채팅 채널을 의미합니다. 
    ②	이 약관에서 사용하는 용어의 정의는 제1항에서 정하는 것을 제외하고는 관련법령에서 정하는 바에 의하며, 관련 법령에서 정하지 않는 것은 일반적인 상관례에 의합니다.
    
    제 3 조 (이용약관의 효력 및 개정)
    ①	본 약관은 웹을 통해 게시하는 방법으로 공시되며 회원의 동의로 효력이 발생합니다. 
    ②	회사는 필요하다고 인정되는 경우 관련 법령을 위배하지 않는 범위에서 본 약관을 개정할 수 있습니다. 
    ③	회사는 약관이 변경되는 경우에는 적용일자 및 변경사유를 명시하여 현행약관과 함께 웹  공지사항 또는 팝업에 그 적용일자로부터 최소한 7일 이전부터 적용일 후 상당한 기간 동안 게시합니다. 다만, 회원의 권리, 의무에 중대한 영향을 주는 변경의 경우에는 적용일자 30일 전부터 이메일주소를 통하여 회원이 인지할 수 있는 방법으로 개별 통지하도록 합니다.
    ④	회원은 개정되는 약관의 전체 또는 일부 내용에 동의하지 않을 수 있습니다. 회원이 본 약관의 변경에 대하여 동의하지 않는 경우 회원탈퇴를 통해 이용계약을 해지할 수 있습니다.
    ⑤	회사가 약관 변경의 공지 또는 개별통지를 통해 개정된 약관의 적용일자로부터 7일(회원에게 불리하거나 중대한 사항의 변경인 경우에는 30일) 내에 이용자가 동의하지 않는다는 의사를 표시하지 아니하면 승인한 것으로 본다는 뜻을 고지하였음에도, 회원이 동의하지 않는다는 의사를 표시하지 않는 경우 약관의 변경에 동의한 것으로 간주합니다. 변경 약관에 대하여 거부의사를 표시한 회원은 계약의 해지 또는 회원 탈퇴를 선택할 수 있습니다
    ...
    제 5 조 (이용계약의 성립)
    회사의 서비스를 이용하고자 하는 경우 본 약관을 읽고 내용에 동의하신 후 소속된 의료기관 의 메일을 기입하여 이용 신청(회원가입 신청)을 하면 이에 대하여 회사가 발송한 인증번호를 입력함으로써 회원가입 절차가 완료됩니다.
    
    제 6 조 (이용 신청의 승낙과 제한)
    ①	회사는 제5조의 규정에 의한 이용신청에 대하여 접수 순서에 따라 서비스 이용을 승낙하되, 다음 각 호에 해당하는 경우에 대해서는 이용 신청을 승낙하지 아니할 수 있습니다.
    1. 타인의 정보 또는 허위의 정보를 이용하여 가입을 신청한 경우
    2. 회사가 정한 신청 요건이 충족되지 않은 경우(회사와 계약을 체결한 의료기관 소속이 아닌 경우 등)
    3. 중복 아이디를 사용하는 경우
    4. 이용제한 조치를 받은 이력이 있는 경우. 단, 회사의 재가입 승낙을 얻은 경우는 제외.
    5. 회사의 이용약관 또는 관련법령 등을 위반하거나 미풍양속을 해칠 목적으로 서비스를 이용하려는 경우
    ②	회사는 아래 사항에 해당하는 경우에는 그 신청에 대하여 승낙 제한 사유가 해소될 때까지 승낙을 유보할 수 있습니다. 다만, 이러한 경우에는 그 사유를 고지하여야 합니다.
    1. 회사가 설비의 여유가 없는 경우
    2. 회사의 기술상 서비스를 제공할 수 없는 경우
    3. 기타 회사가 합리적인 판단에 의하여 필요하다고 인정하는 경우
    ...
    제 7 조 (회원 정보의 변경)
    ①	회원은 환자 관리 탭 내 마이 페이지에서 언제든지 회원 정보를 열람하고 수정할 수 있습니다.
    ②	회원은 이용 신청 시 기재한 정보가 변경된 경우 지체없이 해당 정보를 수정해야 하며, 회사는 회사의 고의 또는 중대한 과실이 없는 한 회원이 이를 수정하지 않아 발생한 불이익에 대한 책임을 지지 않습니다.
    
    제 8 조 (회원에 대한 통지)
    ①	회사가 회원에 대한 통지를 하는 경우 본 약관에 별도 규정이 없는 한 이메일로 할 수 있습니다.
    ②	회사는 회원 전체에 대한 통지의 경우 7일 이상 공지사항에 게시함으로써 제1항의 통지에 갈음할 수 있습니다. 단, 회원의 권리, 의무에 중대한 영향을 주는 내용을 통지하는 경우에는 적용일자 30일 전부터 게시하도록 하고, 회원의 이메일 주소로 개별통지 하도록 합니다.
    ...
    ②	회원 서비스 이용과 관련하여 다음 각 호의 행위를 하여서는 안 됩니다.
    1.	회원가입 신청 또는 정보 변경 시 허위 정보를 입력하거나 정보를 누락하는 행위
    2.	회사가 제공하는 서비스와 관련 없거나 비합리적인 요청, 공서양속에 반하는 행위 등으로 회사의 업무를 방해하는 행위 
    3.	회사 또는 타인의 명예를 훼손하거나 모욕하는 행위
    4.	회사 또는 타인의 지식재산권을 침해하는 행위
    5.	타인으로 가장하거나 타인과의 관계를 허위로 명시하는 행위, 다른 회원의 계정 및 비밀번호를 도용, 부정하게 사용하는 행위
    6.	서비스를 회사의 동의 없이 상업적 목적으로 이용하는 행위
    ...
    12.	기타 회사의 약관을 위반하는 행위
    13.	기타 관련 법령을 위반하거나 미풍양속을 해하는 행위
    ③	회원은 서비스 페이지 상의 공지사항 및 이용약관의 수정사항 등을 확인하고 이를 준수할 의무가 있으며 기타 회사의 업무에 방해되는 행위를 하여서는 안 됩니다
    ④	회원은 개인정보가 타인에게 노출되지 않도록 철저하게 관리하여야 하며, 타인이 회원의 계정을 사용하고 있음을 인지한 경우에는 즉시 회사에 통보하고 적절한 조치를 취해야 하며 회사의 안내가 있는 경우에는 그에 따라야 합니다.
    ⑤	회사는 본 조를 위반하여 회원에게 발생한 불이익에 대하여 회사의 고의 또는 중대한 과실이 없는 한 어떠한 책임도 지지 않습니다.
    
    제 11 조 (서비스의 제공 및 변경)
    ①	회사는 회원의 이용신청을 승낙한 시점부터 회원에게 서비스를 제공합니다. 
    ②	회사는 필요한 경우 서비스 내용을 추가 또는 변경할 수 있습니다. 회사는 서비스 내용에 변경이 있을 경우 공지사항 등을 통해 공지하고, 약관의 개정이 필요할 경우 약관 개정의 절차를 따릅니다. 만일 서비스 내용의 변경으로 인하여 회원의 권리·의무에 불리하거나 중요한 영향을 미치는 경우에는 해당 내용을 그 적용일로부터 30일 전에 공지사항에 공지하고, 회원의 이메일로 개별 통지합니다.
    ③	회사는 서비스가 변경으로 인하여 발생한 문제가 회사의 고의 또는 중대한 과실로 인한 경우를 제외하고는 서비스의 변경으로 발생하는 문제에 대해서 책임을 부담하지 않습니다.
    
    제 12 조 (mDocHomecare 메신저 서비스)
    ①	회원은 “mDocHomecare 챗봇” 및 사전문진서비스를 통해 환자가 제공한 건강상태에 해당하는 답안이 정리된 문진결과를 열람하고, “mDocHomecare 메신저” 서비스를 통해 정기적 또는 비정기적으로 담당 환자와 상담을 진행할 수 있습니다.
    ②	정기상담 서비스를 통하여 생성된 환자와 회원 간의 상담 내용은 회사의 서버에 저장되며, 회사와 각 회원 소속 의료기관 등의 의료진들은 위 상담 내용에 접근하여 열람 및 관리할 수 있습니다.
    ③	환자가 관련 법에 의하여 의료행위로 판단될 우려가 있는 내용이 포함된 상담을 요청하는 경우, 회원은 해당 내용에 대한 상담을 거부할 수 있습니다. 다만, 정당한 상담 거부 사유를 환자에게 고지하여야 합니다.
    
    제 13 조 (상담 관리 서비스)
    ①	회원은 환자의 정기 상담 일정을 변경, 취소할 수 있는 상담 관리 서비스를 이용할 수 있습니다.
    ②	회원은 상담 관리 서비스를 통하여 환자와의 과거 정기 및 비정기 상담 내용을 열람할 수 있습니다.
    ③	회원은 필요한 경우 사전문진서비스를 통하여 정리된 담당 환자의 문진결과 및 상담 내용 정리 파일을 PDF 형태로 제공받을 수 있습니다
    ...
    제 15 조 (서비스 이용 제한)
    ①	회사는 다음 각 호에 해당하는 경우 회원의 동의 없이 서비스 이용을 제한할 수 있습니다. 회사가 회원의 서비스 이용을 제한하게 되는 경우 이메일로 이용 제한 사실 및 그 사유를 통지합니다.
    1.	회원 정보를 허위로 기재한 경우 
    2.	이 약관 및 관련된 별도의 서비스 준수 사항을 위반한 경우 
    3.	타인의 명예를 훼손하거나 모욕한 경우
    4.	회사의 영업을 방해하거나 회사가 제공하는 서비스와 동일한 업무를 행하는 경우 
    5.	회사 또는 다른 회원의 보안을 위협하는 행위를 한 경우
    6.	환자의 개인정보를 본 서비스 외의 목적으로 이용한 경우
    7.	회원이 명예훼손, 모욕, 성적 자기결정권 침해, 기타 사회통념상 건전하지 못한 내용의 요청을 하거나 메신저를 발송하는 경우
    8.	관련법령을 위반하여 본 서비스를 이용한 경우
    ②	회사의 이용제한 조치로 강제 탈퇴 되는 경우 회원의 계정에 보유 중인 상담 내역은 삭제되고 예약된 모든 상담 일정은 자동으로 취소됩니다.
    ③	회사는 회원에게 제1항 각 호에 해당하는 사유가 있을 경우 다음 각 호에 따라 순차적으로 서비스 이용을 제한할 수 있습니다.
    1.	1회 위반: 경고
    2.	2회 위반: 1주일 사용 정지
    3.	3회 위반: 강제 탈퇴
    
    제 16 조 (이용 계약의 해지·해제 등)
    ①	회원은 회사가 정한 절차에 따라 탈퇴 신청을 함으로써 이용계약을 해지할 수 있습니다.
    ②	회원이 계약을 해지하는 경우 관련 법령 및 개인정보처리방침에 따라 회사가 회원정보를 보존하는 경우를 제외하고 회사는 지체없이 회원의 개인정보를 파기합니다.
    ③	회원의 요청에 따라 삭제된 정보는 복구할 수 없습니다.
    ④	다음 각 호의 사유에 해당하는 경우 회사는 회원의 동의 없이 이용계약을 해지하거나 서비스 이용을 중지할 수 있습니다.
    ...
    제 17 조 (개인정보의 보호 및 사용)
    ①	회사는 관계 법령이 정하는 바에 따라 회원의 개인정보를 보호하기 위해 노력합니다. 개인정보의 보호 및 이용에 관해서는 관련 법령 및 회사의 개인정보처리방침을 따릅니다. 
    ②	회사는 회원의 개인정보를 본인의 동의 없이 제3자에게 제공, 분실 또는 유출하여서는 아니됩니다. 단, 회원의 동의를 얻은 경우 및 기타 법률에 특별한 규정이 있는 경우에는 예외로 합니다. 
    ③	회원은 본 서비스 이용 과정에서 얻게 되는 타인(환자, 의료진 포함)의 개인정보를 상업적 목적 또는 개인적 목적으로 사용하여서는 아니 됩니다. 
    ...
    ④	회사는 회원의 귀책사유로 인하여 발생한 손해에 대하여는 회사의 고의 또는 중대한 과실이 없는 한 책임지지 않습니다.
    ⑤	회사가 제공하는 정보와 자료는 개인적 목적 또는 거래의 목적으로 이용될 수 없습니다. 따라서 회원이 본 서비스를 통하여 얻는 정보를 이용하여 본 서비스의 목적을 벗어나 사용함으로써 발생하는 손해 또는 기대이익의 상실에 대하여 회사는 고의 또는 중대한 과실이 없는 한 책임지지 않습니다.
    ⑥	회사는 고의 또는 중과실이 없는 한 회원의 상담 내용으로 인한 손해에 대하여 책임지지 않으며, 기타 회원이 서비스와 관련하여 게재한 정보, 자료, 사실의 신뢰도, 정확성 등의 내용에 관하여 책임을 지지 않습니다.
    ⑦	회원의 상담 내용이 「의료법」, 「의료기사 등에 관한 법률」 및 관련 법령에 의하여 회사의 서비스를 통해 제공될 수 있는 범위를 초과하는 경우에 대하여 회사는 회사의 고의 또는 중대한 과실이 없는 한 책임지지 않습니다.
      ...
      <div className="contact-form">
        <div className="form-header">
         ...
         {platform === "data" ? 
          null
          :
          <SelectBar setValue={setSelect} value = {select} />
          }
        </div>
